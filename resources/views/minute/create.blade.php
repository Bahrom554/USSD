...
@section('main_content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <center><h1>Daqiqalar paketini qo'shish</h1></center>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <form role="form" action="{{route('minute.store')}}" method="POST">
                            {{csrf_field()}}
                            <div class="box-body">
                                <div class="col-lg-offset-3 col-lg-6">
                                    <div class="form-group">
                                        <label for="name">Minute</label>
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Minute" >
                                    </div>
                                    <div class="form-group">
