...
@section('main_content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <center><h1> SMS Paketlar</h1></center>
        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <a class='col-lg-offset-5 btn btn-success' href="{{route('message.create')}}">Yangi SMS Paket qo'shish</a>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($messages as $message)
                                <tr>
                                    ...
                                    <td>{{$message->cost}}</td>
                                    <td>{{$message->time}}</td>
                                    <td>{{$message->turnon}}</td>
                                    <td>{{$message->delete}}</td>
                                    <td>{{$message->check}}</td>
                                    <td>{{$message->category->name}}</td>


                                    <td><a href="{{route('message.edit',$message  ->id)}}"><span class="glyphicon glyphicon-edit"></span></a>
                                    </td>
                                    <td>
